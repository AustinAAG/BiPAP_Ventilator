...
class RespiratorDisplay(QDialog):
    ...
    def makeParamBox(self):
        ...
        self.paramC02.setMaximum(100.0)
        self.paramC02.setDecimals(3)
        ...
        self.paramTexhale.setMaximum(330.0)
        ...
        self.paramH20.setMaximum(100.0)
    ...
    def update_plots(self):
        ...
        try:
            ...
            self.canvas1.axes.set_ybound(lower=-50, upper=50)
